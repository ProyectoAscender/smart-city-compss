...
# print(f'LSB_RELEASE: {LSB_RELEASE} \n' +
#       f'L4T_VERSION: {L4T_VERSION}  \n' +
#       f'JETPACK_VERSION: {JETPACK_VERSION} \n' +
#       f'PYTHON_VERSION: {PYTHON_VERSION} \n' +
#       f'CUDA_VERSION: {CUDA_VERSION} \n' +
#       f'CUDA_SHORT_VERSION: {CUDA_SHORT_VERSION} \n' +
#       f'CUDA_ARCHITECTURES:{CUDA_ARCHITECTURES}  \n')