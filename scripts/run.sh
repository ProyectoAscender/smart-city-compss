...
python3 src/main.py  --edge_ips 192.168.88.249:8883  --mode='udp' --save_results=True --only_results=False --get_speed=True --print_time=True --get_semantic=True --save_plot=True
