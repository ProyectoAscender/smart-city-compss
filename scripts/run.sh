...
python3 src/main.py  --edge_ips 192.168.88.243:8883  --mode='udp' --save_results_csv=True --only_results=False --get_speed=True --print_time=True --get_semantic=True --save_plot=False # > runs/exp/log_$(date +"%Y%m%d_%H%M%S").txt
